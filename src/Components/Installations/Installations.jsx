...
const Installations = () => {
    ...
    return (
        ...
        <div className='grid__layout'>
            ...
            <section className="installations__container">
                <img className='installations__img' src={Image2} alt="El vigilante" />
                <p className="installations__p">Fe, 2016. Lápiz de color sobre cartulina, 50 x 70 cm</p>
            </section>
            <section className="installations__container">
                <img className='installations__img' src={Image3} alt="El vigilante" />
                <p className="installations__p">Librero, 2016. Tinta sobre cartulina, 21 x 30 cm</p>
            </section>
            <section className="installations__container">
                <img className='installations__img' src={Image4} alt="El vigilante" />
                <p className="installations__p">Librero, 2016. Tinta sobre cartulina, 21 x 30 cm</p>
            </section>
            <section className="installations__container">
                <img className='installations__img' src={Image5} alt="El vigilante" />
                <p className="installations__p">Librero, 2016. Tinta sobre cartulina, 21 x 30 cm</p>
            </section>
            <section className="installations__container">
                <img className='installations__img' src={Image6} alt="El vigilante" />
                <p className="installations__p">Librero, 2016. Tinta sobre cartulina, 21 x 30 cm</p>
            </section>
            <section className="installations__container">
                <img className='installations__img' src={Image7} alt="El vigilante" />
                <p className="installations__p">Librero, 2016. Tinta sobre cartulina, 21 x 30 cm</p>
            </section>
            <section className="installations__container">
                <img className='installations__img' src={Image8} alt="El vigilante" />
                <p className="installations__p">Librero, 2016. Tinta sobre cartulina, 21 x 30 cm</p>
            </section>
            <section className="installations__container">
                <img className='installations__img' src={Image9} alt="El vigilante" />
                <p className="installations__p">Librero, 2016. Tinta sobre cartulina, 21 x 30 cm</p>
            </section>
            <section className="installations__container">
                <img className='installations__img' src={Image10} alt="El vigilante" />
                <p className="installations__p">Librero, 2016. Tinta sobre cartulina, 21 x 30 cm</p>
            </section>
