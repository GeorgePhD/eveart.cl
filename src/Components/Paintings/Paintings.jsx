    ...
    return (
        ...
        <div className='grid__layout'>
            <section className="paintings__container">
                ...
                <p className="paintings__p">EL VIGILANTE - 2018 - Tinta sobre papel - 90 x 75 cm</p>
            </section>
            <section className="paintings__container">
                <img className='paintings__img' src={Image2} alt="El vigilante" />
                <p className="paintings__p">Fe, 2016. Lápiz de color sobre cartulina, 50 x 70 cm</p>
            </section>
            <section className="paintings__container">
                <img className='paintings__img' src={Image3} alt="El vigilante" />
                <p className="paintings__p">Librero, 2016. Tinta sobre cartulina, 21 x 30 cm</p>
            </section>
            <section className="paintings__container">
