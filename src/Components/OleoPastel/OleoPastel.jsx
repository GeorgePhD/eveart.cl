    ...
    return (
        ...
        <div className='grid__layout'>
            <section className="oleopastel__container">
                ...
                <p className="oleopastel__p">EL VIGILANTE - 2018 - Tinta sobre papel - 90 x 75 cm</p>
            </section>
            <section className="oleopastel__container">
                <img className='oleopastel__img' src={Image2} alt="El vigilante" />
                <p className="oleopastel__p">Fe, 2016. Lápiz de color sobre cartulina, 50 x 70 cm</p>
            </section>
            <section className="oleopastel__container">
                <img className='oleopastel__img' src={Image3} alt="El vigilante" />
                <p className="oleopastel__p">Librero, 2016. Tinta sobre cartulina, 21 x 30 cm</p>
            </section>
            <section className="oleopastel__container">
